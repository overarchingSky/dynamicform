...
export default {
  ...
  render(h) {
    ...
    nativeOn.mouseenter = on.mouseenter = this.addEventHandle(
      on.mouseenter,
      this.show
    );
    nativeOn.mouseleave = on.mouseleave = this.addEventHandle(
      on.mouseleave,
      this.hide
    );
    ...
    nativeOn.click = on.click = this.addEventHandle(on.click, () => {
      this.focusing = false;
    });
    return vnode;
  },
